...
namespace EState.Controllers
{
    ...
    public class UserAdvertController : Controller
    {
        ...
        public UserAdvertController(IWebHostEnvironment _env)
        {
             env = _env;
        }
        ...
        {
            var list = im.GetList(x => x.AdvertId == id);
            return View(list);
        }
            ...
            if (result.IsValid)
            {
                ...
                if (data.Image != null)
                {
                    ...
                    foreach (var item in data.Image)
                    {
                        ...
                        data.Images.Add(new Image { ImageName = item.FileName, Status = true, AdvertId = image.AdvertId });
